...
// "address_type": "HOME",
// "location_url": "",
// "street_address": "13th Floor, Sy. No: 66/2, 67/1, Trifecta Adatto, ITPL Main Rd, Garudachar Palya",
// "street_address2": ""
export const ToolTip = ({ value }: ToolTipProps) => (
    <Tooltip
        title={
            <div>
                <p>
                    {`${value?.street_address}, ${value?.street_address2}, ${value?.city}, ${value?.state}, ${value?.zipcode}, ${value?.landmark}, ${value?.country}`}
                </p>
            </div>
        }
    >
