      ...
      >
            ...
            <div className='w-[325px] lg:w-[565px] bg-[#151929] mt-6 p-2 lg:p-10 rounded-lg flex flex-col gap-10 items-center'>
              <div className='flex flex-col gap-2 text-[#6A6A78] text-[16px] font-nunitoRegular justify-center items-center'>
                <div className='flex gap-4 justify-center items-center'>
                  <img src={Square} alt='' />
                  <p className='text-[#57CD53] items-center'>Successfully Created</p>
                </div>
                <div className='text-center'>User with Name {name} Created Successfully</div>
              </div>
            </div>
          ) : (
        ...
        {type === 'success' ? (
          <div className='flex justify-center pt-2 pb-10 h-[72px]'>
            <CustomButton onClick={handleClose} width='w-full' variant='contained' size='large'>
              Okay
            </CustomButton>
          </div>
        ) : (
