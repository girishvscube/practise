...
const CustomizedDialogs = ({
  ...
  const { pocList, createSuccess, editSuccess } = useSelector((state: any) => state.poc)
  const { pocDropdown } = useSelector((state: any) => state.dropdown)

  const [pocs, setPocs] = useState<string[]>([])

  console.log('pocList:', pocs)
  ...
  //   }
  //   if (type === 'update') {
  //     dispatch(EditPoc(postdata, pocId))
  //   } else {
  //     dispatch(CreatePoc(postdata))
  //   }
  //   return true
  // }
