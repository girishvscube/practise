...
import MultiUserLogo from '../../../../assets/images/MultiUserLogo.svg';
...
const BasicTable = ({ cols, data, handleClick }: BasicTableProps) => {
  ...
  const handleNavigate = (id: any) => {
    navigate(`/support/tickets/view/${encryptData(id)}`);
  };
        ...
        <TableBody>
          {data.map((item: any) => (
            ...
            >
              ...
              <TableCell align="center">{item?.created_user?.name}</TableCell>
              ...
              <TableCell align="center">{item?.assigned_user?.name || '--'}</TableCell>
              ...
              <TableCell align="center">
                <div className="flex justify-center gap-1 md:gap-2 pr-2 lg:pr-0">
                  ...
                  {item?.assigned_user === null && item.is_reassign_requested ? (
                    <>
