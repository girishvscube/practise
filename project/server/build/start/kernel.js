...
Server_1.default.middleware.registerNamed({
    auth: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/AuthMiddleware'))),
    find: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/FindById'))),
});
