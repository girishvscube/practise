...
class PayIn extends Model_1.default {
    static async listing(query_string) {
        let { page = 1, start_date = '', end_date = '', bank_account_id = '', search_key = '', } = query_string;
        const limit = 10;
...
], PayIn.prototype, "id", void 0);
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
], PayIn.prototype, "customer_id", void 0);
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
], PayIn.prototype, "bank_account_id", void 0);
__decorate([
    Orm_1.column.dateTime(),
    __metadata("design:type", luxon_1.DateTime)
], PayIn.prototype, "pay_in_date", void 0);
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
], PayIn.prototype, "no_of_invoices", void 0);
__decorate([
    (0, Orm_1.column)(),
    __metadata("design:type", Number)
], PayIn.prototype, "notes", void 0);
__decorate([
    Orm_1.column.dateTime({ autoCreate: true }),
    __metadata("design:type", luxon_1.DateTime)
], PayIn.prototype, "createdAt", void 0);
__decorate([
    Orm_1.column.dateTime({ autoCreate: true, autoUpdate: true }),
    __metadata("design:type", luxon_1.DateTime)
], PayIn.prototype, "updatedAt", void 0);
__decorate([
    (0, Orm_1.belongsTo)(() => Customer_1.default, { foreignKey: 'customer_id' }),
    __metadata("design:type", Object)
], PayIn.prototype, "customer", void 0);
__decorate([
    (0, Orm_1.belongsTo)(() => BankAccount_1.default, { foreignKey: 'bank_account_id' }),
    __metadata("design:type", Object)
], PayIn.prototype, "bank_account", void 0);
exports.default = PayIn;
//# sourceMappingURL=PayIn.js.map