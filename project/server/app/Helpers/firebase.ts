...
export async function notify(devices: any, data: any) {
    try {
        console.log(data)

        console.log(devices, 'devices')
        // const messaging = firebase.messaging()
        _.each(devices, async (device) => {
...
const secret: any = {
    ...
    client_x509_cert_url:
        'https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-ilsoq%40test-notification-515c9.iam.gserviceaccount.com',
}

// export const firebase: any = initializeApp({
//     credential: admin.credential.cert(secret),
// })
